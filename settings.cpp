...
void set::processWeaponSettings(const nlohmann::json& j, std::uint8_t gun, bool mode) noexcept {
	if (!j.empty()) {
...
void set::loadWeaponSettings(const nlohmann::json& j, std::uint8_t gun, bool mode) noexcept {
...
void set::loadSettings(nlohmann::json& j) noexcept {
	try {
...
void set::saveSettings(nlohmann::json& j) const noexcept {
