...
void visuals::d3Create() {
	pFontNick_ = std::make_unique<CD3DFont>("Small Fonts", 7, FCR_BORDER);
	pFontNickBar_ = std::make_unique<CD3DFont>("Small Fonts", 6, FCR_BORDER);
	pRender_ = std::make_unique<CD3DFont>("Tahoma", 7, FCR_BORDER);
	pBox_ = std::make_unique<CD3DRender>(128);
}
...
void visuals::imguiStyle() {
	auto style{ &ImGui::GetStyle() };
	style->Colors[ImGuiCol_Text] = { 0.80f, 0.80f, 0.83f, 1.00f };
	style->Colors[ImGuiCol_TextDisabled] = { 0.24f, 0.23f, 0.29f, 1.00f };
	style->Colors[ImGuiCol_WindowBg] = { 0.f, 0.f, 0.f, 0.94f };
	style->Colors[ImGuiCol_ChildBg] = { 0.07f, 0.07f, 0.09f, 1.00f };
	style->Colors[ImGuiCol_PopupBg] = { 0.f, 0.f, 0.f, 0.94f };
	style->Colors[ImGuiCol_Border] = { 0.06f, 0.05f, 0.07f, 1.00f };
	style->Colors[ImGuiCol_BorderShadow] = { 0.06f, 0.05f, 0.07f, 1.00f };
	style->Colors[ImGuiCol_FrameBg] = { 0.f, 0.f, 0.f, 1.f }; 
	style->Colors[ImGuiCol_FrameBgHovered] = { 0.01f, 0.01f, 0.01f, 1.f };
	style->Colors[ImGuiCol_FrameBgActive] = { 0.01f, 0.01f, 0.01f, 1.f };
	style->Colors[ImGuiCol_TitleBg] = { 0.f, 0.f, 0.f, 1.f };
	style->Colors[ImGuiCol_TitleBgCollapsed] = { 0.f, 0.f, 0.f, 1.f };
	...
	style->Colors[ImGuiCol_ScrollbarGrab] = { 0.02f, 0.02f, 0.02f, 1.f };
	style->Colors[ImGuiCol_ScrollbarGrabHovered] = { 0.02f, 0.02f, 0.02f, 1.f };
	style->Colors[ImGuiCol_ScrollbarGrabActive] = { 0.02f, 0.02f, 0.02f, 1.f };
	style->Colors[ImGuiCol_CheckMark] = { 1.f, 0.f, 0.f, 1.f };
	style->Colors[ImGuiCol_SliderGrab] = { 0.02f, 0.02f, 0.02f, 1.f };
	style->Colors[ImGuiCol_SliderGrabActive] = { 0.03f, 0.03f, 0.03f, 1.f };
	style->Colors[ImGuiCol_Button] = { 0.f, 0.f, 0.f, 1.f };
	style->Colors[ImGuiCol_ButtonHovered] = { 0.01f, 0.01f, 0.01f, 1.f };
	style->Colors[ImGuiCol_ButtonActive] = { 0.f, 0.f, 0.f, 0.78f };
	style->Colors[ImGuiCol_Header] = { 0.01f, 0.01f, 0.01f, 1.f };
	style->Colors[ImGuiCol_HeaderHovered] = { 0.02f, 0.02f, 0.02f, 1.f };
	style->Colors[ImGuiCol_HeaderActive] = { 0.007f, 0.007f, 0.007f, 1.f };
	style->Colors[ImGuiCol_Separator] = { 0.f, 0.f, 0.f, 1.f };
	style->Colors[ImGuiCol_SeparatorHovered] = { 0.24f, 0.23f, 0.29f, 1.00f };
	style->Colors[ImGuiCol_SeparatorActive] = { 0.56f, 0.56f, 0.58f, 1.00f };
	style->Colors[ImGuiCol_ResizeGrip] = { 0.00f, 0.00f, 0.00f, 0.00f };
	style->Colors[ImGuiCol_ResizeGripHovered] = { 0.56f, 0.56f, 0.58f, 1.00f };
	style->Colors[ImGuiCol_ResizeGripActive] = { 0.06f, 0.05f, 0.07f, 1.00f };
	style->Colors[ImGuiCol_Tab] = { 0.40f, 0.39f, 0.38f, 0.16f };
	style->Colors[ImGuiCol_TabHovered] = { 0.40f, 0.39f, 0.38f, 0.39f };
	style->Colors[ImGuiCol_TabActive] = { 0.40f, 0.39f, 0.38f, 1.00f };
	...
	style->Colors[ImGuiCol_TextSelectedBg] = { 1.f, 0.f, 0.f, 1.f };
}

void visuals::imguiRender() {
...
void visuals::imguiDestroy() {
	ImGui_ImplDX9_Shutdown();
	ImGui_ImplWin32_Shutdown();
	ImGui::DestroyContext();
}

void visuals::imguiShowTooltip(const std::string& str) {
	ImGui::BeginTooltip();
	ImGui::TextUnformatted(str.c_str());
	ImGui::EndTooltip();
}

void visuals::imguiMenuSettings() {
	ImGui::PushItemWidth(85.f);
	if (ImGui::BeginCombo("##1", /*7 probelov*/"      Packets", ImGuiComboFlags_NoArrowButton)) {
	...
	if (ImGui::BeginCombo("##3", set::i().main.modeOnv ? "OnVisibility: ON" : "OnVisibility: OFF", ImGuiComboFlags_NoArrowButton)) {
		ImGui::PushStyleColor(ImGuiCol_FrameBg, { 0.007f, 0.007f, 0.007f, 1.0f });
		ImGui::Checkbox("OnVisibility", &set::i().main.modeOnv);
		ImGui::PopStyleColor();
		ImGui::PushStyleColor(ImGuiCol_Separator, { 0.02f, 0.02f, 0.02f, 1.0f });
		ImGui::Separator();
		ImGui::PopStyleColor();
		ImGui::PushStyleColor(ImGuiCol_FrameBg, { 0.007f, 0.007f, 0.007f, 1.0f });
	...
	static bool tg;
	ImGui::PushItemWidth(85.f);
	if (ImGui::BeginCombo("##5", set::i().main.fracStr.c_str(), ImGuiComboFlags_NoArrowButton)) {
		...
		if (!tg) {
			...
			if (const auto [res, j] { set::i().getJSON("/settings/frac") }; res) {
				for (const auto& buf : j.get<nlohmann::json::object_t>()) {
					if (!buf.second.empty()) {
		...
		if (set::i().main.frac >= 0 && set::i().main.frac <= 2) {
			static constexpr const char* fracStr[3]{ "None","All","Frac" };
			ImGui::PushStyleColor(ImGuiCol_Button, { 0.007f, 0.007f, 0.007f, 1.0f });
			ImGui::Button(fracStr[set::i().main.frac], { 85.f, 18.f });
			if (ImGui::IsItemClicked()) {
				if (set::i().main.frac == 0 || set::i().main.frac == 1) {
					set::i().main.frac = set::i().main.frac ? 0 : 1;
		...
		ImGui::PushStyleColor(ImGuiCol_FrameBg, { 0.007f, 0.007f, 0.007f, 1.0f });
		for (std::size_t i{}; const auto & buf : vecFrac) {
			if (ImGui::Checkbox(buf.first.c_str(), reinterpret_cast<bool*>(&vecFracBool.data()[i]))) {
				if (vecFracBool[i]) {
					if (const auto [res, j] { set::i().getJSON("/settings/frac/" + buf.first) }; res && !j.empty()) {
						const auto vb{ j.get<std::vector<std::uint16_t>>() };
					...
					for (std::size_t n{}; n < set::i().main.fracName.size(); n++) {
						if (set::i().main.fracName[n] == buf.first) {
							set::i().main.fracName.erase(set::i().main.fracName.begin() + n);
							if (const auto [res, j] { set::i().getJSON("/settings/frac/" + buf.first) }; res && !j.empty()) {
								for (const auto& buf : j.get<std::vector<std::uint16_t>>()) {
									dmgFuncs::i().removeInVectorByValue(set::i().main.skin, buf);
								}
							}
						}
					}
					static constexpr std::uint8_t value1{ 1 };
					set::i().main.frac = dmgFuncs::i().findInVector(vecFracBool, value1) ? 2 : 0;
	...
	static constexpr const char* weaponsName[35]{
	...
	if (ImGui::IsItemClicked()) {
		if (dmgFuncs::i().checkIDLimit(localId) && dmgFuncs::i().remotePlayerIsListed(localId)) {
			if (const auto name{ sampFuncs::i().getRemotePlayerName(localId) }; !dmgFuncs::i().findInVector(set::i().main.ignoreList, name)) {
	...
	if (ImGui::IsItemClicked()) {
		if (dmgFuncs::i().checkIDLimit(localId2) && dmgFuncs::i().remotePlayerIsListed(localId2)) {
			if (const auto name{ sampFuncs::i().getRemotePlayerName(localId2) }; !dmgFuncs::i().findInVector(set::i().main.blackList, name)) {
...
void visuals::imguiMenuMisc() {
	...
	static bool tg;
	ImGui::PushItemWidth(85.f);
	if (ImGui::BeginCombo("##16", fracList.c_str(), ImGuiComboFlags_NoArrowButton)) {
			...
			if (!tg2) {
				...
				if (!fracList.empty()) {
					if (const auto [res, j] { set::i().getJSON("/settings/frac") }; res && !j[fracList].empty()) {
						const auto miscBufFrac{ j[fracList].get<std::vector<int>>() };
						skinIdStr = dmgFuncs::i().dobavitZapyatuyu(miscBufFrac);
					}
				}
				tg2 = true;
			}
	...
	if (ImGui::IsItemClicked()) {
		if (!fracList.empty() && fracList != "None") {
			if (auto [res, j] { set::i().getJSON() }; res) {
				if (const auto vb{ j["settings"]["frac"][fracList].get<std::vector<int>>() }; !dmgFuncs::i().findInVector(vb, skinId)) {
					j["settings"]["frac"][fracList].push_back(skinId);
					set::i().saveJSON(j);
				}
			}
		}
	...
	if (ImGui::IsItemClicked()) {
		if (!fracList.empty() && fracList != "None") {
			if (auto [res, j] { set::i().getJSON() }; res) {
				if (auto vb{ j["settings"]["frac"][fracList].get<std::vector<int>>() }; !vb.empty()) {
					dmgFuncs::i().removeInVectorByValue(vb, skinId);
					j["settings"]["frac"][fracList] = vb;
					set::i().saveJSON(j);
				}
			}
		}
...
void visuals::d3Initialize(IDirect3DDevice9* pDevice) {
...
void visuals::d3Menu() {
	const auto str{ std::format(
		...
		dmgFuncs::i().checkActivate() ? set::i().main.gDMGStr : ""
	) };
	pRender_->Print(str.c_str(), -1, set::i().main.d3menuX, set::i().main.d3menuY);
}

void visuals::wallhack() {
	...
	for (std::uint16_t i{}; i < limits::SAMP_MAX_PLAYERS; i++) {
		...
		const auto remoteName{ sampFuncs::i().getRemotePlayerName(i) };
		...
		pFontNick_->Print(nameStr.c_str(), dmgFuncs::i().calcNameColor(remoteColor), screenPos.fX, screenPos.fY, false);
		...
		pBox_->D3DBoxBorder(screenPos.fX, screenPos.fY + (remoteArmour > 0.f ? 19.f : 13.f), 42.f, 5.f, D3DCOLOR_ARGB(255, 0, 0, 0), D3DCOLOR_ARGB(100, 0, 0, 0));
		pBox_->D3DBox(screenPos.fX + 1.f, screenPos.fY + (remoteArmour > 0.f ? 20.f : 14.f), remoteHealth / 2.5f, 3.f, D3DCOLOR_ARGB(222, 227, 0, 5));
		pFontNickBar_->Print(std::to_string(remoteHealth2).c_str(), D3DCOLOR_ARGB(255, 255, 255, 255), screenPos.fX + 41.5f, screenPos.fY + (remoteArmour > 0.f ? 18.f : 10.f));

		if (remoteArmour > 0.f) {
			pBox_->D3DBoxBorder(screenPos.fX, screenPos.fY + 13.f, 42.f, 5.f, D3DCOLOR_ARGB(255, 0, 0, 0), D3DCOLOR_ARGB(100, 0, 0, 0));
			pBox_->D3DBox(screenPos.fX + 1.f, screenPos.fY + 14.f, remoteArmour / 2.5f, 3.f, D3DCOLOR_ARGB(255, 255, 255, 255));
			pFontNickBar_->Print(std::to_string(remoteArmour2).c_str(), D3DCOLOR_ARGB(255, 255, 255, 255), screenPos.fX + 41.5f, screenPos.fY + 10.f);
		}
		...
		pFontNick_->Print(infoStr.c_str(), D3DCOLOR_XRGB(255, 255, 255), screenPos.fX, screenPos.fY + (remoteArmour > 0.f ? 26.f : 17.f));
	}
}
...
void visuals::line() {
	if (dmgFuncs::i().checkActivate() && dmgFuncs::i().remotePlayerIsExist(set::i().main.gDMGId)) {
		const auto myPos{ dmgFuncs::i().getLocalPlayerPos() }, remotePlayerPos{ dmgFuncs::i().getRemotePlayerPos(set::i().main.gDMGId) };
		if (const auto screenMyPos{ dmgFuncs::i().calcScreenCoords(myPos) }, screenPlayerPos{ dmgFuncs::i().calcScreenCoords(remotePlayerPos) }; screenMyPos.fZ >= 1.f && screenPlayerPos.fZ >= 1.f) {
			pBox_->D3DLine(screenMyPos.fX, screenMyPos.fY, screenPlayerPos.fX, screenPlayerPos.fY, D3DCOLOR_XRGB(255, 0, 0));
		}
	}
}