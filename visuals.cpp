...
void visuals::imguiStyle() {
	...
	style->Colors[ImGuiCol_Text] = { 0.8f, 0.8f, 0.83f, 1.f };
	style->Colors[ImGuiCol_TextDisabled] = { 0.24f, 0.23f, 0.29f, 1.f };
	style->Colors[ImGuiCol_WindowBg] = { 0.f, 0.f, 0.f, 0.94f };
	style->Colors[ImGuiCol_ChildBg] = { 0.07f, 0.07f, 0.09f, 1.f };
	style->Colors[ImGuiCol_PopupBg] = { 0.f, 0.f, 0.f, 0.94f };
	style->Colors[ImGuiCol_Border] = { 0.06f, 0.05f, 0.07f, 1.f };
	style->Colors[ImGuiCol_BorderShadow] = { 0.06f, 0.05f, 0.07f, 1.f };
	...
	style->Colors[ImGuiCol_MenuBarBg] = { 0.1f, 0.09f, 0.12f, 1.f };
	...
	style->Colors[ImGuiCol_SeparatorHovered] = { 0.24f, 0.23f, 0.29f, 1.f };
	style->Colors[ImGuiCol_SeparatorActive] = { 0.56f, 0.56f, 0.58f, 1.f };
	style->Colors[ImGuiCol_ResizeGrip] = { 0.f, 0.f, 0.f, 0.f };
	style->Colors[ImGuiCol_ResizeGripHovered] = { 0.56f, 0.56f, 0.58f, 1.f };
	style->Colors[ImGuiCol_ResizeGripActive] = { 0.06f, 0.05f, 0.07f, 1.f };
	style->Colors[ImGuiCol_Tab] = { 0.4f, 0.39f, 0.38f, 0.16f };
	style->Colors[ImGuiCol_TabHovered] = { 0.4f, 0.39f, 0.38f, 0.39f };
	style->Colors[ImGuiCol_TabActive] = { 0.4f, 0.39f, 0.38f, 1.f };
	style->Colors[ImGuiCol_PlotLines] = { 0.4f, 0.39f, 0.38f, 0.63f };
	style->Colors[ImGuiCol_PlotLinesHovered] = { 0.25f, 1.f, 0.f, 1.f };
	style->Colors[ImGuiCol_PlotHistogram] = { 0.4f, 0.39f, 0.38f, 0.63f };
	style->Colors[ImGuiCol_PlotHistogramHovered] = { 0.25f, 1.f, 0.f, 1.f };
...
void visuals::imguiMenuSettings() {
	...
	if (static bool tg; ImGui::BeginCombo("##5", set::i().main.fracStr.c_str(), ImGuiComboFlags_NoArrowButton)) {
		...
		if (set::i().main.frac >= 0 && set::i().main.frac <= 2) {
			static const char* const fracStr[3]{ "None","All","Frac" };
	...
	static const char* const weaponsName[35]{
