...
std::uint8_t dmgFuncs::getExtZoom(std::uint8_t gun) const {
	static const std::map<std::uint8_t, std::uint8_t> mGetExtZoom{
		{ 30, 27 }, { 31, 27 },
		{ 33, 0 },
	};
...
std::uint8_t dmgFuncs::getWeaponState(std::uint8_t gun) const {
	static const std::map<std::uint8_t, std::uint8_t> mGetWeaponState{
...
std::uint8_t dmgFuncs::getCamMode(std::uint8_t gun) const {
	...
	static const std::map<std::uint8_t, std::uint8_t> mGetCamMode{
