...
public:
	...
	HRESULT		Print(const char* text, D3DCOLOR color, float x, float y, bool skipColorTags = true, bool noColorFormat = false);
...
public:
	...
	void	DrawPolygon(float x, float y, int triangleAmount, float radius, D3DCOLOR color); //
private:
