...
public:
	...
	[[nodiscard]] static sampFuncs& i() noexcept;
	...
	[[nodiscard]] static std::tuple<std::uint32_t, sampVer> getSampBaseAndVer() noexcept;
	[[nodiscard]] static bool sampInit() noexcept;
	...
	void disableNameTags(bool state) const noexcept;
	...
	[[nodiscard]] stSAMPPed* getLocalSampPed() const noexcept;
	...
	[[nodiscard]] stSAMPPed* getRemotePlayerSampPed(std::uint16_t id) const noexcept;
